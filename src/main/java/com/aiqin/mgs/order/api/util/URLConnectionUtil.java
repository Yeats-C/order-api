...
public class URLConnectionUtil {
    private static Logger log = LoggerFactory.getLogger(URLConnectionUtil.class);
    ...
    public static String doGet(String url, Map<String, String> headers, Map<String, Object> params) {
        log.info("Start 请求URL:" + url + " headers:" + headers + " params:" + params);
        ...
        try {
            ...
            log.info("End 请求URL:" + url + " headers:" + headers + " params:" + params);
    ...
    public static String doPost(String apiUrl, Map<String, String> queryParams, Map<String, String> headers, Object params, boolean paramsFormatStringEntity) {
        log.info("Start 请求URL:" + apiUrl + " headers:" + headers + " params:" + params);
