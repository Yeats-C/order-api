...
public class ExcelUtil {
    ...
    private static final int DATA_FORMAT_CODE_58 = 58;
    private static final String BUILT_IN_FORMAT_STRING = "h:mm";
     ...
     * @throws IOException
     */
    public static List<String[]> getExcelDataList(MultipartFile file) throws IOException {
        checkFile(file);
        //获得Workbook工作薄对象
        Workbook workbook;
    ...
    private static String stringDateProcess(Cell cell) {
        ...
        if (HSSFDateUtil.isCellDateFormatted(cell)) {
            ...
            if (cell.getCellStyle().getDataFormat() == HSSFDataFormat.getBuiltinFormat(BUILT_IN_FORMAT_STRING)) {
        ...
        } else if (cell.getCellStyle().getDataFormat() == DATA_FORMAT_CODE_58) {
            ...
            // 单元格设置成常规
            if (DATA_FORMAT_STRING_GENERAL.equals(temp)) {
                format.applyPattern("#");
            }
