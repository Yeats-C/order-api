...
public class SettlementServiceImpl implements SettlementService{
	...
	@Override
	public HttpResponse settlement(SettlementInfo info,List<CartInfo> cartInfoList,OrderConditionInfo conditionInfo) {
		...
		//生成订单号
		String orderCode = OrderPublic.currentDate()+String.valueOf(conditionInfo.getOriginType())+String.valueOf(Global.ORDERID_channel_4)+OrderPublic.randomNumberF();
...
//			
//			//删除购物车信息 (针对微商城)未完成
//			if(info.getOriginType().equals(Global.ORIGIN_TYPE_1)) {
//				String memberId = "";
//				try {
...
//		}
	 ...
	 * @return
	 */
	private OrderInfo getOrderInfo(String orderCode, SettlementInfo info,OrderConditionInfo conditionInfo) {
...
//		orderInfo.setUpdateBy();
	 ...
	 * @return
	 */
	private OrderPayInfo getPayInfo(String orderCode,SettlementInfo info,OrderConditionInfo conditionInfo) {
