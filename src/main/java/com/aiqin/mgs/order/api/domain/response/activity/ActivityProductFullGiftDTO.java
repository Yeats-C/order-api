...
@Data
@ApiModel("营销活动 满赠商品dto")
public class ActivityProductFullGiftDTO extends PagesRequest {
    ...
    @ApiModelProperty(value = "满赠活动折扣dto list")
    @JsonProperty("discount_DTO_list")
    private List<ActivityProductFullGiftDiscountDTO> discountDTOList;
