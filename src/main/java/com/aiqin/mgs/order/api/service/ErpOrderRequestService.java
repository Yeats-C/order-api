...
public interface ErpOrderRequestService {
     ...
     */
    boolean areaCheck(StoreInfo storeInfo, List<OrderStoreOrderProductItem> orderProductItemList);
     ...
     * @date 2019/12/2 16:11
     */
    boolean repertoryCheck(StoreInfo storeInfo, List<OrderStoreOrderProductItem> orderProductItemList);
     ...
     * @date 2019/12/2 16:11
     */
    boolean priceCheck(StoreInfo storeInfo, List<OrderStoreOrderProductItem> orderProductItemList);
     ...
     * @date 2019/12/2 16:11
     */
    boolean activityCheck(StoreInfo storeInfo, List<OrderStoreOrderProductItem> orderProductItemList);
