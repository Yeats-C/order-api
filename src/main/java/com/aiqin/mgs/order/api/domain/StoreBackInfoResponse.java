...
public class StoreBackInfoResponse {
    ...
    private BigDecimal freeCost=BigDecimal.ZERO;

    @ApiModelProperty("首单赠送市值余额")
    @JsonProperty(value = "market_value_balance")
    private BigDecimal marketValueBalance=BigDecimal.ZERO;

    @ApiModelProperty("首单赠送费用余额")
    @JsonProperty(value = "free_cost_balance")
    private BigDecimal freeCostBalance=BigDecimal.ZERO;

    @ApiModelProperty("可用赠品额度")
    @JsonProperty(value = "available_gift_quota")
    private BigDecimal availableGiftQuota=BigDecimal.ZERO;
